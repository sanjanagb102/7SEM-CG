...
Button Toolbar::eraseButton;
Button Toolbar::moveButton;
Button Toolbar::rotateButton;
...
int Tool_Erase::flickerFrameCount;
bool Tool_Erase::flickerColor;
bool Tool_Erase::isMouseDown;
int Tool_Erase::startMouseX;
int Tool_Erase::startMouseY;
int Tool_Erase::endMouseX;
int Tool_Erase::endMouseY;
bool Tool_Erase::isDisplaying;
#include "Tool_Rotate.h"
int Tool_Rotate::flickerFrameCount;
bool Tool_Rotate::flickerColor;
bool Tool_Rotate::isMouseDown;
int Tool_Rotate::startMouseX;
int Tool_Rotate::startMouseY;
int Tool_Rotate::endMouseX;
int Tool_Rotate::endMouseY;
bool Tool_Rotate::isDisplaying;
