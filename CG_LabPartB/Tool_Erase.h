...
*/
void Tool_Erase::Display(int window_width, int window_height) {
	if ((!Tool_Erase::isDisplaying) || isMouseDown) {
...
*/
bool Tool_Erase::Pressed(int button, int state, int x, int y) {
...
*/
bool Tool_Erase::BlockMousePress(int button, int state, int x, int y) {
	if (isMouseDown) {
...
/*
	...
	@return Has the tool handled the event?
*/
bool Tool_Erase::SpecialKey(int key, int x, int y) {
	if (isDisplaying) {
